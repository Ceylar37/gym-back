...
const trainingHistoryService = new TrainingHistoryService(prisma.trainingHistory);
const trainingHistoryController = new TrainingHistoryController(trainingHistoryService);
